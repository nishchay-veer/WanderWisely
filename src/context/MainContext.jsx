...
export const MainContextProvider = ({ children }) => {
    ...
    // Get Filtered Places by Type
    // useEffect(() => {
    //     // Places filter by type for Map view
    //     // Set new filteredPlaces on change of 'type' state 
    //     // filter in only data with 'type' property equal to the selcted type value
    //     let add = type + 's';
    //     setFilteredPlaces(places?.filter(place => place.ranking_category === add))
    //     places?.map(place => console.log(place.ranking_category))
    // }, [type])
